...
description: Breaks a specification or clear requirements into ordered, verifiable tasks. Use when work is too large to start directly or has dependencies that need sequencing.
---
