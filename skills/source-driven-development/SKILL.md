...
```
package.json                         → TypeScript (Node, React, Next, Vite, …)
...
|----------|--------|---------|
| 1 | Official documentation | react.dev, docs.djangoproject.com, fastapi.tiangolo.com, typescriptlang.org/docs |
...
- Not reading `package.json` or `pyproject.toml` before implementing
